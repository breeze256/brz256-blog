...
updated: 2026-02-22T13:37:00.000+08:00
hidden: false
tags:
  - OI
categories:
...
## 应用 
### 矩阵加速递归（斐波那契数列）
在 [斐波那契数列 (Fibonacci Sequence)](https://oi-wiki.org/math/combinatorics/fibonacci/) 中，设$F_i$为第$i$项的值，则$F_1 = F_2 = 1, F_i = F_{i - 1} + F_{i - 2} (i \geq 3)$。那么常规方法就是写$for$循环一直递归下去，但很显然数量级一大就不行了。
